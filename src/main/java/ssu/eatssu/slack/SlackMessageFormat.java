...
public class SlackMessageFormat {
	...
	*신고 INFO*
	...
	"""
        ...
        // 디미터 법칙 위반
        Object[] args = {reporter.getId(), reporter.getNickname(), review.getId(),
            review.getUser().getId()
            , review.getUser().getNickname(), review.getMenu().getName(), review.getContent(),
            review.getModifiedDate().toString(), report.getReviewReportType().getDescription(),
	...
	*문의 내용*
	...
	"""
        ...
        Object[] args = {inquiry.getUser().getId(), inquiry.getUser().getNickname(),
